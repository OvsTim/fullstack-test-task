...
- [x] как запустить
- [x] ASCII-схема слоёв (буквально 5–7 строк)
- [x] какие баги нашли
- [x] инварианты бизнес-логики (таблица heuristics)
- [x] что за оптимизация и какой от неё эффект
- [x] почему не микросервисы / Kafka / S3
- [x] что сознательно не делали (auth, ClamAV, пагинация…) и почему
